...
public class correctionGridTest80 
    extends TestCase
{	
	//roll 2 skulls, reroll one of them due to sorceress, then go to next round of turn

	public void test80() throws ClassNotFoundException {
		try {
			int port = 0;
			ServerSocket s;
        	...
        	assertEquals(1, Game.countObject(Object.SKULL, Fortune.SORCERESS, 0, player1.dice));
        } 
        catch (Exception e) { 
